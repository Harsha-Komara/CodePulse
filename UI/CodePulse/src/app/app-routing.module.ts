...
const routes: Routes = [
  ...
  {
    path: 'admin/categories/addCategory', component: AddCategoryComponent, canActivate: [authGuard]
  },
  {
  ...
  {
    path: 'admin/blogpost/addblogpost', component: AddBlogpostComponent, canActivate: [authGuard]
  },
  {
